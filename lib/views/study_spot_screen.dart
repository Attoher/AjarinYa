                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Latitude: ${(_selectedLat ?? fallbackLat).toStringAsFixed(6)}\nLongitude: ${(_selectedLng ?? fallbackLng).toStringAsFixed(6)}',
            ...
            ElevatedButton(
              onPressed: () async {
                if (_formKey.currentState?.validate() ?? false) {
                  final lat = _selectedLat ?? fallbackLat;
                  final lng = _selectedLng ?? fallbackLng;
